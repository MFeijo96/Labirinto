...
public class Algoritmo {
    ...
    private static List<String> direcoes;
    ...
    public static void setDirecoes(List<String> direcoes) {
    	Algoritmo.direcoes = direcoes;
    }
    
    public static List<String> getDirecoes() {
    	return Algoritmo.direcoes;
    }
